...
contract ContractCollaborationManagerTest {
    ...
    */
    function testAddTask() public {
        ...
        uint[] memory req;
        ccm.createTask("A", supervisor, ContractCollaborationManager.Tasktype.TASK, req);
    ...
    */
    //TODO Ist relevant ob ein Task 2x eingechecked werden kann? Dann eventuell Contractcode auf require erweitern
    ...
    */
    function testSimpleTaskChain() public {
        ...
        //
        uint[] memory reqA;
        ccm.createTask("A", supervisor, ContractCollaborationManager.Tasktype.TASK, reqA);

        uint[] memory reqB = new uint[](1);
        reqB[0] = 1;        
        ccm.createTask("B", supervisor, ContractCollaborationManager.Tasktype.TASK, reqB);
        Assert.equal(3, ccm.getTaskCount(), "Taskcount should 2 because A,A,B already added");

        uint[] memory reqC = new uint[](1);
        reqC[0] = 2;
        ccm.createTask("C", supervisor, ContractCollaborationManager.Tasktype.TASK, reqC);
    ...
    */
    function testDBexclusiveIntegerGateWay() public {
        ...
        // id = 4
        uint[] memory requA;
        ccm.createTask("A", supervisor, ContractCollaborationManager.Tasktype.TASK, requA);

        // id = 5
        uint[] memory requB = new uint[](1);
        requB[0] = 4;
        ccm.createTask("B", supervisor, ContractCollaborationManager.Tasktype.TASK, requB);
        
        // id = 6

        uint[] memory requC = new uint[](1);
        requC[0] = 5;
        ccm.createTask("C", supervisor, ContractCollaborationManager.Tasktype.TASK, requC);
        ...
        requD[0] = 5;
        ccm.createTask("D", supervisor, ContractCollaborationManager.Tasktype.TASK, requD);
        ...
        requE[0] = 5;
        ccm.createTask("E", supervisor, ContractCollaborationManager.Tasktype.TASK, requE);
        ...
        requF[0] = 6;
        ccm.createTask("F", supervisor, ContractCollaborationManager.Tasktype.TASK, requF);
        

        // id = 10
        uint[] memory requG = new uint[](1);
        requG[0] = 7;
        ccm.createTask("G", supervisor, ContractCollaborationManager.Tasktype.TASK, requG);
        
        // id = 11
        uint[] memory requH = new uint[](1);
        requH[0] = 8;
        ccm.createTask("H", supervisor, ContractCollaborationManager.Tasktype.TASK, requH);
        ...
        requZ[1] = 10;
        requZ[2] = 11;
        ccm.createTask("Z", supervisor, ContractCollaborationManager.Tasktype.XOR, requZ);
